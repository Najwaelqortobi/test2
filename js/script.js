        ...
        /* botonesCategorias.forEach(boton => boton.addEventListener("click", () => {
            ...
            function cargarProductos(productosElegidos) {
                ...
                productosElegidos.forEach(producto => {
                    ...
                    // Añadir evento de clic al div del producto
                    div.addEventListener('click', () => redirigirAProducto(producto.id));
            ...
            function redirigirAProducto(productoId) {
                // Redirigir a producto.html con el ID del producto como parámetro de URL
